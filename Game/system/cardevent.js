import { addPickedCard, isCardPicked, resetPickedCards } from "../storage.js";
import { getCredit, subtractCredit } from "../system/credit.js";
...
export function showCardEvent(container) {
  ...
  const CARD_POOL = ["Knife", "Bullets",  "Square", "Rectangle"];
